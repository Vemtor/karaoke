...
public class FlaskRequestQueueService {
  ...
  public Map<String, Object> queueFlaskRequest(String youtubeUrl, String serverUrl)
      throws Exception {
    ...
    try {
      ...
      throw new Exception(
          "Flask request timed out after " + PROCESSING_TIMEOUT_MINUTES + " minutes");
    } catch (Exception e) {
            ...
            try {
              ...
              try {
                Map<String, Object> result =
                    flaskRequestExecutor.processAudio(task.youtubeUrl, task.serverUrl);
  ...
  private static class FlaskTask {
    ...
    public FlaskTask(
        String youtubeUrl, String serverUrl, CompletableFuture<Map<String, Object>> future) {
