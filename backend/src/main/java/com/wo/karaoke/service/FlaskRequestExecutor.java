...
public class FlaskRequestExecutor {
  ...
  public Map<String, Object> processAudio(String youtubeUrl, String serverUrl)
  ...
  private String sendToFlaskServer(String youtubeUrl, String serverUrl)
      throws IOException, InterruptedException {
    String fullUrl =
        serverUrl + "?youtube_url=" + URLEncoder.encode(youtubeUrl, StandardCharsets.UTF_8);
