    ...
    const fetchData = async () => {
      ...
      try {
        const res = await fetch(
          `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${debouncedSearch}&type=video&maxResults=10&key=AIzaSyAcyaA3htasw-LLJQwBJvZzCbM2o6stE4s`
        )
  ...
  return (
    <View style={{ flex: 1, marginTop: 50 }}>
      ...
      <ThemedView>
        ...
        {loading && (
          <ActivityIndicator size="small" color="#555" style={{ marginVertical: 10 }} />
        )}
        <FlatList
          data={videos}
